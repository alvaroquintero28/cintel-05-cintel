...
ui.page_opts(title="PyShiny Express: Too cold to be outside", fillable=True)

# Sidebar is typically used for user interaction/information
# Note the with statement to create the sidebar followed by a colon
# Everything in the sidebar is indented consistently
with ui.sidebar(open="open", style="background-color: lightblue"):

    ui.h2("Sweater Weather", class_="text-center")
    ui.p(
        "light sweater or heavy jacket?.",
        class_="text-center",
    )
    ui.hr()
    ui.h6("Links:")
    ui.a(
        "GitHub Source",
        href="https://alvaroquintero28.github.io/cintel-05-cintel/",
        target="_blank",
    )
    ui.a(
        "GitHub App",
...
with ui.layout_columns():
    ...
    with ui.card(full_screen=True, style="background-color: lightblue;"):
...
with ui.card(style="background-color: lightblue;"):
